...
def collect_jobs(
    ...
    for index, original_url in enumerate(urls, start=1):
        ...
        if index % checkpoint_every == 0:
            ...
            print(
                f"\nCheckpoint saved: "
                f"{len(successful_records)} successful records."
            )
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="Delay between requests. Default: 1 seconds.",
    )
    ...
    parser.add_argument(
        ...
        default=50,
        help=(
            "Save successful records after this many "
            "processed URLs. Default: 50."
        ),
    )
